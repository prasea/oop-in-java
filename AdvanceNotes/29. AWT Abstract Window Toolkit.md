...
class MyFrame extends Frame implements WindowListener {
  ...
  public void windowClosing(WindowEvent e) { 
    ...
    System.exit(0); //0 means no errors
  }
...
In Java, there are multiple ways to handle events. We look at **four approaches** using a simple counter application:
...
* Can we create an object of an interface ActionListener? When creating object of interface then you should override that method. So it becomes an anonymous class. 
...
## Handling Menu Events - ActionEvent
...
## Example: Drawing a Circle at Mouse Click
